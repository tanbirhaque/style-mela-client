...
const Product_info = ({ productID }) => {
    ...
    return (
        <div>
            <div>
                <Tabs>
                    <TabList className={`bg-black rounded-t-[20px] flex justify-center gap-5 text-[18px]`}>
                        <Tab className={`text-white py-5 px-5 cursor-pointer`}>Description</Tab>
                    ...
                    <div className='bg-[#f5f5f5]'>
                        <div className='max-w-[1200px] mx-auto py-[60px]'>
                            ...
                            <TabPanel>
                                <div>
                                    <div>
                                        <h2 className='font-jost font-bold text-[30px]'>Game Console Controller Cable</h2>
                                    </div>
                                    <div className='mt-8'>
                                        <Markdown>
                                            {description}
