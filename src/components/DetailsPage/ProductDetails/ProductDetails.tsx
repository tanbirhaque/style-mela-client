  ...
  return (
    <div className="pl-[72px] mt-[92px]">
      ...
      <div>
        ...
        {/* Short Description */}
        <p className="text-[#333] mb-4 max-w-[430px] text-[16px]">
          {shortDescription}
        </p>
      </div>
      {/* Add to cart */}
      ...
      <div className="flex items-center gap-6 mt-12">
        <div className="w-fit text-[19px] border border-gray-300 flex items-center gap-5 px-5 py-4 rounded-[10px] ">
          <p>Add To Wishlist</p>
          <span>
            <PiHeartLight className="text-[22px]"></PiHeartLight>
          </span>
        </div>
        <div className="flex items-center gap-3 text-[19px]">
          <p>Share</p>
          <span>
            <PiShareNetworkLight className="text-[22px]"></PiShareNetworkLight>
          </span>
        </div>
      </div>
      {/* Category */}
      <div className="mt-6">
        <h3 className="font-bold">
          Category <span className="text-[#858997]">Wigs</span>
        </h3>
      </div>
    </div>
  );
